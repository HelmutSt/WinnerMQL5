...
- HYP2 noch nicht mit echten Trade-Ergebnissen testbar: die einzige aktuell existierende VRR-Regel generiert Trades nur für `IS_TOUCHED`, nicht für `IS_POSTBREAK_RETEST_TOUCHED` (569 Events vorhanden, 0 Trades).
